    ...
    public void testLayout()
    {
        ...
        try
        {
...

            {
                ...
                // Remove the appender and close the file.
                lRootLogger.removeAppender(lAppender);
                lAppender.close();
            }

            {
                // Open the JSON log file.
                final FileInputStream lLogStream = new FileInputStream(lTempLog);
                final JSONParser lLogParser = new JSONParser(lLogStream);
